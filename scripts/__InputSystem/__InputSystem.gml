...
// directions when collecting input from analogue thumbsticks. A value of `0` will provide no
// overlap which means each cardinal direction will exist in 90 degree slices. A value of `1` will
...
// trigonometry. `0.5` feels about right though.
#macro __INPUT_THUMBSTICK_OVERLAP_FACTOR  0.5
